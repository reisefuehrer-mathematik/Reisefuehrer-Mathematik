...
\begin{document}
    ...
    \begin{example}{}
        ...
        \begin{center}
            \begin{tikzpicture}
                \fill[orange!10, draw=orange, text=orange] (0,0) rectangle (4,4) node[pos=.5, align=center]{$1000\,\text{m}\times 1000\,\text{m}$\\$= 1000^2\,\text{m}^2$};
                \draw[decorate, decoration = {calligraphic brace, raise=5pt, amplitude=5pt}]
                    (0,0) -- (0,4)
                    node[pos=0.5,left=10pt,black]{$1000\,\text{m}$};
                \draw[decorate, decoration = {calligraphic brace, raise=5pt, amplitude=5pt}]
                    (0,4) -- (4,4)
                    node[pos=0.5,above=10pt,black]{$1000\,\text{m}$};

                \fill[blue!10, draw=blue, text=blue] (6,1.5) rectangle +(4,1) node[pos=.5, align=center]{$1000\,\text{m}\times 1\,\text{m}$\\$= 1000\,\text{m}^2$};
                \draw[decorate, decoration = {calligraphic brace, raise=5pt, amplitude=5pt}]
                    (6,1.5) -- +(0,1)
                    node[pos=0.5,left=10pt,black]{$1\,\text{m}$};
                \draw[decorate, decoration = {calligraphic brace, raise=5pt, amplitude=5pt}]
                    (6,2.5) -- +(4,0)
                    node[pos=0.5,above=10pt,black]{$1000\,\text{m}$};
            \end{tikzpicture}
