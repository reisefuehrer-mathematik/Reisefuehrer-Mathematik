...
\begin{example}{Wahrheitswerte von $\liff$}
    ...
    \statement{Der Zaubertrank verleiht Superkräfte} durch $F$ 
    und \statement{Der Zauberer ist munter} durch $M$ ab. 
    Wir haben den Konnektor \statement{$\liff$}
    ...
    nicht 
    munter ($M$ ist \falsch), dann ist trotzdem $F \liff M$
     \wahr, da $F$ und 
    $M$ 
