...
\begin{document}
    ...
    Dieses Beispiel lässt auch wieder verallgemeinern. Egal welche zwei Aussagen $A,B$ wir 
    ...
    darzustellen bzw. umzuformen. Zusammengefasst wissen wir jetzt also, dass:
     \[A \implies B \equiv \lnot B \implies \lnot A \equiv \lnot A \lor B\]
    ...
    \todo{kommen äquivalenzumformungen von termen hier nach oder hier vor? Wenn hier vor, dann 
    erwänhne, dass man überprüfen kann ob etwas eine äquivalenzumformungen ist, indem mn die Implikationen
