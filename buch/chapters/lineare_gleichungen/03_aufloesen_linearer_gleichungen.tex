...
\begin{example}
    ...
    (und mit $2x-2$ haben wir wieder die Form $ax+b$). Deshalb ist auch die Gleichung $5(x+4)=2(3+x)-8$ linear.
\end{example}
...
\begin{center}
    \includegraphics[height=11cm]{images/justitia.jpg}
\end{center}
...
Zum Abschluss dieses Abschnitts wenden wir unser neues Wissen an, um die noch offene Frage aus Beispiel \ref{ex:handball_quali}, das in der Einführung vorkam, zu beantworten.
\begin{example}
    Während der Einführung haben wir in Beispiel \ref{ex:handball_quali} die folgende Gleichung aufgestellt: 
