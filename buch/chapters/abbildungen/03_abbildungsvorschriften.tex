...
\begin{example}
    \parpic[r]{
        \begin{tikzpicture}
            \node[blue] at (0,0) {$\underbrace{\text{Schaufel}}_{\textcolor{green!60!black}{\text{8 Buchstaben}}}$};
            \node[blue] at (0.6,1) {$\underbrace{\text{Tennis}}_{\textcolor{green!60!black}{\text{6 Buchstaben}}}$};
            \node[blue] at (3,0.4) {$\underbrace{\text{Fuß}}_{\textcolor{green!60!black}{\text{3 Buchstaben}}}$};
            \node[blue] at (2.8,1.5) {$\underbrace{\text{lachen}}_{\textcolor{green!60!black}{\text{6 Buchstaben}}}$};
        \end{tikzpicture}
    }
