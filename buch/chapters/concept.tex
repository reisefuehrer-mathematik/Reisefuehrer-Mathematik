...
Auf den nächsten Seiten stellen wir dir unser Buch und die dazugehörigen Materialien vor und erklären dir, wie du damit möglichst sinnvoll arbeiten kannst. Wir haben diese Erklärungen danach aufgeteilt, was dich vermutlich interessiert -- abhängig davon, ob du ein Lehrer, ein Schüler oder nichts von beidem bist.
...
\begin{tikzpicture}
    \node[draw,rectangle] (11-6) at (0,0) {11.6 Nullstellen und Achsenabschnitt};
    \node[draw,rectangle] (12-5) at (0,-1) {12.5 Geradengleichungen};
    \draw[-latex] (11-6) -- (12-5);
\end{tikzpicture}
