...
\begin{document}
    ...
    \ldsection{Einführung}
    \ldsection{Formale Schreibweisen}
    \ldsection{Abbildungsvorschriften}
    \ldsection{Abbildungsgraphen}
    \ldsection{Hintereinanderausführung}
    \ldsection{Eigenschaften von Abbildungen}
    \ldsection{Abbildungsgraphen modifizieren}
