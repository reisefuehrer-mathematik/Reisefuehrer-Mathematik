...
\begin{document}
    ...
    \ldsection{Extremwerte und Wendepunkte}
    \ldsection{Ableitung der Exponentialfunktion}
    \ldsection{Ableitung von trigonometrischen Funktionen}
    \ldsection{Wachstumsprozesse}
